...
<body>
    <form action="{{ route('events.store') }}" method="POST">
        ...
        <div class="logIn_pg">
            ...
            <div class="input_field">
                <input type="text" name="name" placeholder="Event">
                <br>
            ...
            <select name="user_id" id="user_id" class="bordered rounded">
    ...
    <a class="btn btn-primary ms-4" href="{{ route('events.index') }}">Back TO List</a>
</body>
</html>